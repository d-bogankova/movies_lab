...
CREATE TABLE `movies` (
  ...
  `original_language` varchar(2) COLLATE utf8_bin NOT NULL,
  `overview` text COLLATE utf8_bin NOT NULL,
  `popularity` float NOT NULL,
  `poster_path` varchar(255) COLLATE utf8_bin NOT NULL,
  `backdrop_path` varchar(255) COLLATE utf8_bin NOT NULL,
